...
export default function Dashboard() {
  ...
  const signTransaction = (password) => {};

  //here make the sign through enfora (call to signTransaction)
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div class="pb-4">
        {state.wallet &&
          state.wallet.accounts.map((a, i) => {
            return (
              <div
                class={
                  "flex justify-left gap-2 pt-2 pb-1 border-b-2 border-gray-300 " +
